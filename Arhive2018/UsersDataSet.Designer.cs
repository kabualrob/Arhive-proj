...
namespace Arhive2018 {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class USERDataTable : global::System.Data.TypedTableBase<USERRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public USERRow AddUSERRow(string FIO, string DESCRIPTION, string LOGIN, string PASSWORD, bool ISADMIN, bool BLOCKED) {
        ...
        public partial class USERRow : global::System.Data.DataRow {
            ...
            public bool BLOCKED {
                get {
                    return ((bool)(this[this.tableUSER.BLOCKEDColumn]));
                }
                set {
                    this[this.tableUSER.BLOCKEDColumn] = value;
                }
            }
...
namespace Arhive2018.UsersDataSetTableAdapters {
    ...
    public partial class USERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[USER] ([FIO], [DESCRIPTION], [LOGIN], [PASSWORD], [ISADMIN], [" +
                "BLOCKED]) VALUES (@FIO, @DESCRIPTION, @LOGIN, @PASSWORD, @ISADMIN, @BLOCKED)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ISADMIN", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ISADMIN", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@BLOCKED", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "BLOCKED", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE       [USER]\r\nSET                FIO = @FIO, DESCRIPTION = @DESCRIPTION, L" +
                "OGIN = @LOGIN, PASSWORD = @PASSWORD, ISADMIN = @ISADMIN, BLOCKED = @BLOCKED\r\nWHE" +
                "RE        (ID = @ID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@FIO", global::System.Data.SqlDbType.NVarChar, 100, global::System.Data.ParameterDirection.Input, 0, 0, "FIO", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@LOGIN", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "LOGIN", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ISADMIN", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "ISADMIN", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@BLOCKED", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "BLOCKED", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FIO, DESCRIPTION, LOGIN, PASSWORD, ISADMIN, BLOCKED FROM dbo.[USER]";
        ...
        public virtual int Insert(string FIO, string DESCRIPTION, string LOGIN, string PASSWORD, string ISADMIN, string BLOCKED) {
            if ((FIO == null)) {
            ...
            if ((ISADMIN == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(ISADMIN));
            }
            if ((BLOCKED == null)) {
                throw new global::System.ArgumentNullException("BLOCKED");
            }
            else {
                this.Adapter.InsertCommand.Parameters[5].Value = ((string)(BLOCKED));
            }
        ...
        public virtual int Update(string FIO, string DESCRIPTION, string LOGIN, string PASSWORD, string ISADMIN, string BLOCKED, int ID) {
            if ((FIO == null)) {
                throw new global::System.ArgumentNullException("FIO");
            }
            else {
            ...
            if ((ISADMIN == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(ISADMIN));
            }
            if ((BLOCKED == null)) {
                throw new global::System.ArgumentNullException("BLOCKED");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(BLOCKED));
            }
